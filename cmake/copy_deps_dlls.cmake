...
foreach (DLL_NAME ${DLL_NAMES})
    if (EXISTS ${DLL_SOURCE_DIR}/${DLL_NAME})
        message(STATUS "copy: '${DLL_SOURCE_DIR}/${DLL_NAME}' -> '${DLL_DEST_DIR}/${DLL_NAME}'")
        file(COPY_FILE ${DLL_SOURCE_DIR}/${DLL_NAME} ${DLL_DEST_DIR}/${DLL_NAME} ONLY_IF_DIFFERENT)
        configure_file(${DLL_SOURCE_DIR}/${DLL_NAME} ${DLL_DEST_DIR}/${DLL_NAME})
    else ()
        message(WARNING "DLL file '${DLL_SOURCE_DIR}/${DLL_NAME}' does not exist!")
    endif ()
